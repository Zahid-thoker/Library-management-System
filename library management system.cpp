...
void mainmenu()
{
	...
	case '4':
		...
		printf("Programmers....");
		gotoxy(16,4);
		printf("1. zahid thoker (zahid/kazata/khalid/wahid/rohie)");
		gotoxy(16,5);
		printf("   Mobile:7889339718  E-mail:zahidthoker788@gmail.com");
		gotoxy(16,7);
		printf("2.kazata sheikh (ccc)");
		gotoxy(16,8);
		printf("   Mobile:123456789  E-mail:HUMI786@gmail.com");
		gotoxy(16,10);
		printf("3. khalid  muktar    (MI)");
		gotoxy(16,11);
		printf("   Mobile:979700000   E-mail:MIDU786@gmail.com");
		gotoxy(16,13);
		printf("4.wahid (ZU)");
		gotoxy(16,15);
		printf(" Mobile:9622876534 E-mail:zuni123@gmail.com");
		gotoxy(16,17);
		printf("5.Rohie jan(TANKY)");
		gotoxy(16,19);
		printf("Mobile:1234567892 E-mai:TAMKY122@gmail.com");
		gotoxy(16,21);
		printf("6.Rohie jan (HUMA)");
		gotoxy(16,23);
		printf("Mobile:9797754867 E-mail:huma111@gmail.com");
		gotoxy(16,25);
		printf("With  the Unexplainable Help of 6 STARS(hmtz)");
		gotoxy(10,17);
